...
const LeaderModal: React.FC<LeaderModalProps> = ({
  ...
  // const [likeCount, setLikeCount] = useState(data ? data.likeCount : 0);
  ...
  // );
  return (
    <div className={`alertpop ${isOpen ? 'open' : ''}`} style={{ zIndex: 9 }}>
      <div className="leader-modal-bg" onClick={onClose} style={style}>
            ...
            <div className="info">
              ...
              <div className="btns">
                ...
                >
                  ...
                  />
                  {/* {data.likeCount} */}
                  {isLiked[data.title] ? data.filledLikeCount : data.likeCount}
                </button>
                <Link to={'/imagination'}>
